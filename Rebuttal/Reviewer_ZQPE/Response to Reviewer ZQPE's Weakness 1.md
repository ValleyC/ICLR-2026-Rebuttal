...
This limitation is shared by coordinate-based methods (AM, POMO, Pointer Networks, DIFUSCO, T2T, Fast-T2T). Current ATSP solvers (MatNet [5], GREAT [6]) incorporate directional edge information fundamentally incompatible with E(2)-equivariant coordinate encoders.
