...
3. **PO clarification:** After careful study, PO [4] is a training algorithm, not a solver architecture. It can be applied to POMO, Sym-NCO, AM to improve training. Including it in our CVRP comparison would not be appropriate, as we are comparing solvers, not training methods.
